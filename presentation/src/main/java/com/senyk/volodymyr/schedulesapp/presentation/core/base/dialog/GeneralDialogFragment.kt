...
import com.senyk.volodymyr.schedulesapp.databinding.DialogFragmentBaseBinding
...
abstract class GeneralDialogFragment : BaseDialogFragment<DialogFragmentBaseBinding>() {
    ...
    override fun initView() {
        ...
        with(dialogFragmentContent as GeneralDialogFragmentContent) {
            binding.outputDialogTitle.text = title
            binding.outputDialogMessage.text = message
