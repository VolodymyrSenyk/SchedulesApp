...
import com.senyk.volodymyr.schedulesapp.view.adapterdelegate.listener.PairsClickListener;
import com.senyk.volodymyr.schedulesapp.view.adapter.recyclerview.pairs.EditPairsListAdapter;
import com.senyk.volodymyr.schedulesapp.view.adapter.recyclerview.pairs.ShowPairsListAdapter;
...
import com.senyk.volodymyr.schedulesapp.viewmodel.pairsmanagement.OneDayScheduleViewModel;
...
public class OneDayScheduleFragment extends BaseFragment implements PairsClickListener, WarningClickListener {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        this.viewModel = new ViewModelProvider(requireActivity(), this.viewModelFactory)
